...
difficulty = 1  # Установите значение от 0 до 1
...
while True:
    ...
    if yes_or_no == 'no':
        ...
        while True:
            if score_bota > 21:
                print("Бот проиграл.\nТак как у него", score_bota,
                      "очков, а у вас ", score_playera)
                input("Нажмите Enter, чтобы закрыть")
                exit(0)

            if score_bota > score_playera:
                print("Бот победил.\nТак как у него", score_bota, "очков, а у вас ",
            ...
            if score_bota < score_playera and score_bota >= 15:
                print("Вы победили.\nТак как у вас", score_playera, "очков, а у бота ",
                      score_bota, "\nПоздравляем!")
                input("Нажмите Enter, чтобы закрыть")
                exit(0)

            if score_bota < 15 or (random.random() < difficulty and min([cart for cart in all_carts if cart + score_bota <= 21]) in all_carts):
                ...
                print("Бот решил не брать карту")
                break
